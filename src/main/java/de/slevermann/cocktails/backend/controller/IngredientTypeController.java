...
public class IngredientTypeController {
    ...
    @GetMapping
    public PagedTypes getAll(@RequestParam(name = "page", defaultValue = "1") @Min(1) final int page,
    ...
    public PagedIngredients getIngredients(@RequestParam(name = "page", defaultValue = "1") @Min(1) final int page,
                                           @RequestParam(name = "pageSize", defaultValue = "20") @Min(1) @Max(50) final int pageSize,
